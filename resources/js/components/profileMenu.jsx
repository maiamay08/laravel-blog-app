...
export default function ProfileMenu({ username, avatar, dashboardUrl, adminDashboardUrl, isAdmin }){
    const handleLogout = () => {
        ...
        <DropdownMenu.Root>
            <DropdownMenu.Trigger asChild>
                <button type="button" className="round-btn">
                    <img src={avatar} alt="profile-img" className="cover rounded-full w-10 h-10 overflow-auto"/>
                </button>
            ...
            <DropdownMenu.Portal>
                <DropdownMenu.Content sideOffset={12} align="end" className="bg-white shadow-lg top-12 right-0 rounded-lg overflow-hidden font-light">
                    ...
                    <DropdownMenu.Item>
                        <a href={isAdmin ? adminDashboardUrl : dashboardUrl} className="block hover:bg-slate-100 pl-4 pr-8 py-2 mb-1">Dashboard</a>
                    </DropdownMenu.Item>
